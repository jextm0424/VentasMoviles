		...
		<tbody>
			<c:forEach items="${ventas }" var="venta">
				<tr>
					...
					<td>
						<button onclick="borrarventa(${venta.idVenta},this)" class="btn btn-danger">Eliminar</button> 
						<a href="<c:url value="/modificarVenta?idVenta=${venta.idVenta}"/>" class="btn btn-info">Modificar</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
